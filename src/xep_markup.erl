...
do_encode({markup_link} = Link, TopXMLNS) ->
...
encode_markup_link({markup_link}, __TopXMLNS) ->
    __NewTopXMLNS =
	xmpp_codec:choose_top_xmlns(<<"https://xabber.com/protocol/markup">>,
				    [], __TopXMLNS),
    _els = [],
