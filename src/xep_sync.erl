...
do_get_name({sync_conversation, _, _, _, _, _, _, _,
	     _}) ->
    <<"conversation">>;
...
do_get_ns({sync_call, _}) ->
    <<"https://xabber.com/protocol/synchronization">>;
do_get_ns({sync_conversation, _, _, _, _, _, _, _,
	   _}) ->
    <<"https://xabber.com/protocol/synchronization">>;
...
get_els({sync_query, _stamp, _rsm, _xdata, _sub_els}) ->
    _sub_els;
get_els({sync_conversation, _type, _jid, _status,
...
set_els({sync_conversation, _type, _jid, _status,
	 _stamp, _thread, _mute, _pinned, _},
	_sub_els) ->
    {sync_conversation, _type, _jid, _status, _stamp,
...
records() ->
    [{sync_synchronization, 0}, {sync_query, 4},
     {sync_conversation, 8}, {sync_metadata, 2},
     {sync_retract, 1}, {sync_unread, 2},
     {sync_displayed, 1}, {sync_delivered, 1},
     {sync_last, 1}, {sync_call, 1}].
...
decode_sync_call(__TopXMLNS, __Opts,
    ...
    __Els = decode_sync_call_els(__TopXMLNS, __Opts, _els,
				 []),
    {sync_call, __Els}.
...
decode_sync_call_els(__TopXMLNS, __Opts,
    ...
    case proplists:get_bool(ignore_els, __Opts) of
      true ->
	  decode_sync_call_els(__TopXMLNS, __Opts, _els,
			       [_el | __Els]);
      false ->
...
decode_sync_last(__TopXMLNS, __Opts,
    ...
    __Els = decode_sync_last_els(__TopXMLNS, __Opts, _els,
				 []),
    {sync_last, __Els}.
...
decode_sync_last_els(__TopXMLNS, __Opts,
    ...
    case proplists:get_bool(ignore_els, __Opts) of
      true ->
	  decode_sync_last_els(__TopXMLNS, __Opts, _els,
			       [_el | __Els]);
      false ->
	  __XMLNS = xmpp_codec:get_attr(<<"xmlns">>, _attrs,
					__TopXMLNS),
...
decode_sync_delivered(__TopXMLNS, __Opts,
    ...
    Id = decode_sync_delivered_attrs(__TopXMLNS, _attrs,
				     undefined),
    {sync_delivered, Id}.
...
decode_sync_displayed(__TopXMLNS, __Opts,
    ...
    Id = decode_sync_displayed_attrs(__TopXMLNS, _attrs,
				     undefined),
    {sync_displayed, Id}.
...
decode_sync_unread_attrs(__TopXMLNS,
    ...
    decode_sync_unread_attrs(__TopXMLNS, _attrs, _val,
			     After);
decode_sync_unread_attrs(__TopXMLNS,
			 [{<<"after">>, _val} | _attrs], Count, _After) ->
    decode_sync_unread_attrs(__TopXMLNS, _attrs, Count,
			     _val);
...
decode_sync_retract(__TopXMLNS, __Opts,
    ...
    Version = decode_sync_retract_attrs(__TopXMLNS, _attrs,
					undefined),
...
decode_sync_metadata(__TopXMLNS, __Opts,
    ...
    __Els = decode_sync_metadata_els(__TopXMLNS, __Opts,
				     _els, []),
    Node = decode_sync_metadata_attrs(__TopXMLNS, _attrs,
				      undefined),
...
decode_sync_metadata_els(__TopXMLNS, __Opts,
    ...
    case proplists:get_bool(ignore_els, __Opts) of
      true ->
	  decode_sync_metadata_els(__TopXMLNS, __Opts, _els,
				   [_el | __Els]);
      false ->
	  __XMLNS = xmpp_codec:get_attr(<<"xmlns">>, _attrs,
					__TopXMLNS),
...
decode_sync_conversation(__TopXMLNS, __Opts,
    ...
    __Els = decode_sync_conversation_els(__TopXMLNS, __Opts,
					 _els, []),
    {Jid, Type, Status, Stamp, Thread, Mute, Pinned} =
	decode_sync_conversation_attrs(__TopXMLNS, _attrs,
				       undefined, undefined, undefined,
				       undefined, undefined, undefined,
				       undefined),
    {sync_conversation, Type, Jid, Status, Stamp, Thread,
     Mute, Pinned, __Els}.
...
decode_sync_conversation_els(__TopXMLNS, __Opts,
    ...
    case proplists:get_bool(ignore_els, __Opts) of
      true ->
	  decode_sync_conversation_els(__TopXMLNS, __Opts, _els,
				       [_el | __Els]);
      false ->
	  __XMLNS = xmpp_codec:get_attr(<<"xmlns">>, _attrs,
					__TopXMLNS),
...
encode_sync_conversation({sync_conversation, Type, Jid,
			  Status, Stamp, Thread, Mute, Pinned, __Els},
			 __TopXMLNS) ->
    __NewTopXMLNS =
	xmpp_codec:choose_top_xmlns(<<"https://xabber.com/protocol/synchronization">>,
				    [], __TopXMLNS),
...
decode_sync_query(__TopXMLNS, __Opts,
    ...
    {Xdata, Rsm, __Els} = decode_sync_query_els(__TopXMLNS,
						...
						undefined, []),
    Stamp = decode_sync_query_attrs(__TopXMLNS, _attrs,
				    undefined),
...
decode_sync_query_els(__TopXMLNS, __Opts,
	...
	of
	  ...
	  decode_sync_query_els(__TopXMLNS, __Opts, _els, Xdata,
...
decode_sync_query_els(__TopXMLNS, __Opts,
	...
	of
      <<"jabber:x:data">> ->
	  decode_sync_query_els(__TopXMLNS, __Opts, _els,
...
encode_sync_query({sync_query, Stamp, Rsm, Xdata,
		   __Els},
		  __TopXMLNS) ->
    __NewTopXMLNS =
	xmpp_codec:choose_top_xmlns(<<"https://xabber.com/protocol/synchronization">>,
