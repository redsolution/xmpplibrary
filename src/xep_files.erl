...
records() ->
    [{files_file_sharing, 2}, {files_sources, 1},
     {files_file, 2}].

decode_files_media_type(__TopXMLNS, __Opts,
			{xmlel, <<"media-type">>, _attrs, _els}) ->
    Cdata = decode_files_media_type_els(__TopXMLNS, __Opts,
					_els, <<>>),
    Cdata.
...
decode_files_media_type_els(__TopXMLNS, __Opts,
    ...
    decode_files_media_type_els(__TopXMLNS, __Opts, _els,
...
decode_files_file_els(__TopXMLNS, __Opts,
	...
	of
      <<"https://xabber.com/protocol/files">> ->
	  decode_files_file_els(__TopXMLNS, __Opts, _els,
				decode_files_media_type(<<"https://xabber.com/protocol/files">>,
							__Opts, _el),
				__Els);
      _ ->
	  decode_files_file_els(__TopXMLNS, __Opts, _els, Type,
				[_el | __Els])
    end;
decode_files_file_els(__TopXMLNS, __Opts,
...
decode_files_sources(__TopXMLNS, __Opts,
    ...
    __Els = decode_files_sources_els(__TopXMLNS, __Opts,
				     _els, []),
    {files_sources, __Els}.
...
decode_files_sources_els(__TopXMLNS, __Opts,
    ...
    case proplists:get_bool(ignore_els, __Opts) of
      true ->
	  decode_files_sources_els(__TopXMLNS, __Opts, _els,
				   [_el | __Els]);
      false ->
	  __XMLNS = xmpp_codec:get_attr(<<"xmlns">>, _attrs,
					__TopXMLNS),
...
decode_files_file_sharing(__TopXMLNS, __Opts,
    ...
    {Sources, File} =
	decode_files_file_sharing_els(__TopXMLNS, __Opts, _els,
				      error, error),
...
encode_files_file_sharing({files_file_sharing, File,
			   Sources},
			  __TopXMLNS) ->
    __NewTopXMLNS =
	xmpp_codec:choose_top_xmlns(<<"https://xabber.com/protocol/files">>,
