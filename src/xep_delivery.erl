...
decode_delivery_x(__TopXMLNS, __Opts,
                  {xmlel, <<"x">>, _attrs, _els}) ->
    __Els = decode_delivery_x_els(__TopXMLNS,
                                  __Opts,
                                  _els,
                                  []),
    {delivery_x, __Els}.
...
decode_delivery_x_els(__TopXMLNS, __Opts,
    ...
    case proplists:get_bool(ignore_els, __Opts) of
        true ->
            decode_delivery_x_els(__TopXMLNS,
                                  __Opts,
                                  _els,
                                  [_el | __Els]);
        false ->
...
decode_delivery_retry(__TopXMLNS, __Opts,
    ...
    To = decode_delivery_retry_attrs(__TopXMLNS,
                                     _attrs,
                                     undefined),
    {delivery_retry, To}.
...
decode_delivery_received(__TopXMLNS, __Opts,
    ...
    {Forwarded, Stanza_id, Origin_id, Time} =
        decode_delivery_received_els(__TopXMLNS,
                                     __Opts,
                                     _els,
                                     undefined,
                                     undefined,
...
encode_delivery_received({delivery_received,
                          Origin_id,
                          Stanza_id,
                          Time,
                          Forwarded},
