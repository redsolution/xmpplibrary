...
get_els({replace, _xmlns, _id, _by, _version,
	 _conversation, _type, _replace_message, _sub_els}) ->
    _sub_els;
get_els({replace_message, _from, _to, _body, _stanza_id,
	 _replaced, _sub_els}) ->
    _sub_els.

set_els({replace, _xmlns, _id, _by, _version,
	 _conversation, _type, _replace_message, _},
	_sub_els) ->
    {replace, _xmlns, _id, _by, _version, _conversation,
     _type, _replace_message, _sub_els};
set_els({replace_message, _from, _to, _body, _stanza_id,
	 _replaced, _},
	_sub_els) ->
    {replace_message, _from, _to, _body, _stanza_id,
     _replaced, _sub_els}.
...
records() ->
    [{retract_message, 7}, {retract_all, 5},
     {retract_user, 7}, {replace, 8}, {replace_message, 6},
     {replaced, 2}, {retract_query, 3},
...
decode_retract_invalidate(__TopXMLNS, __Opts,
    ...
    {Version, Conversation, Type} =
	decode_retract_invalidate_attrs(__TopXMLNS, _attrs,
...
encode_retract_invalidate({retract_invalidate, Version,
			   Conversation, Type},
			  __TopXMLNS) ->
    __NewTopXMLNS =
...
decode_retract_query(__TopXMLNS, __Opts,
	...
	decode_retract_query_attrs(__TopXMLNS, _attrs,
				   undefined, undefined, undefined),
...
decode_retract_query_attrs(__TopXMLNS,
			   ...
			   Less_than) ->
    decode_retract_query_attrs(__TopXMLNS, _attrs, _val,
			       Version, Less_than);
decode_retract_query_attrs(__TopXMLNS,
			   [{<<"version">>, _val} | _attrs], Type, _Version,
			   Less_than) ->
    decode_retract_query_attrs(__TopXMLNS, _attrs, Type,
			       _val, Less_than);
decode_retract_query_attrs(__TopXMLNS,
...
encode_retract_query({retract_query, Version, Less_than,
		      Type},
		     __TopXMLNS) ->
    __NewTopXMLNS =
...
decode_replace_message(__TopXMLNS, __Opts,
	...
	decode_replace_message_els(__TopXMLNS, __Opts, _els,
				   undefined, undefined, undefined, []),
    {From, To} = decode_replace_message_attrs(__TopXMLNS,
					      _attrs, undefined, undefined),
    {replace_message, From, To, Body, Stanza_id, Replaced,
     __Els}.
...
decode_replace_message_els(__TopXMLNS, __Opts,
	...
	of
      ...
      _ ->
	  decode_replace_message_els(__TopXMLNS, __Opts, _els,
				     Replaced, Stanza_id, Body, [_el | __Els])
    end;
decode_replace_message_els(__TopXMLNS, __Opts,
...
decode_replace_message_attrs(__TopXMLNS,
    ...
    decode_replace_message_attrs(__TopXMLNS, _attrs, _val,
				 To);
decode_replace_message_attrs(__TopXMLNS,
			     [{<<"to">>, _val} | _attrs], From, _To) ->
    decode_replace_message_attrs(__TopXMLNS, _attrs, From,
				 _val);
...
encode_replace_message({replace_message, From, To, Body,
			Stanza_id, Replaced, __Els},
		       __TopXMLNS) ->
    __NewTopXMLNS = xmpp_codec:choose_top_xmlns(<<>>,
						[<<"https://xabber.com/protocol/rewrite">>,
						 <<"https://xabber.com/protocol/rewrite#notify">>],
...
decode_replace(__TopXMLNS, __Opts,
	...
	decode_replace_els(__TopXMLNS, __Opts, _els, undefined,
			   []),
    {Type, Xmlns, Id, Version, Conversation, By} =
	decode_replace_attrs(__TopXMLNS, _attrs, undefined,
			     undefined, undefined, undefined, undefined,
			     undefined),
    {replace, Xmlns, Id, By, Version, Conversation, Type,
     Replace_message, __Els}.
...
decode_replace_els(__TopXMLNS, __Opts,
	...
	of
      <<"https://xabber.com/protocol/rewrite">> ->
	  decode_replace_els(__TopXMLNS, __Opts, _els,
			     decode_replace_message(<<"https://xabber.com/protocol/rewrite">>,
						    __Opts, _el),
			     __Els);
      <<"https://xabber.com/protocol/rewrite#notify">> ->
...
decode_replace_attrs(__TopXMLNS,
    ...
    decode_replace_attrs(__TopXMLNS, _attrs, _val, Xmlns,
			 Id, Version, Conversation, By);
decode_replace_attrs(__TopXMLNS,
		     [{<<"xmlns">>, _val} | _attrs], Type, _Xmlns, Id,
		     Version, Conversation, By) ->
    decode_replace_attrs(__TopXMLNS, _attrs, Type, _val, Id,
			 Version, Conversation, By);
decode_replace_attrs(__TopXMLNS,
		     [{<<"id">>, _val} | _attrs], Type, Xmlns, _Id, Version,
		     Conversation, By) ->
    decode_replace_attrs(__TopXMLNS, _attrs, Type, Xmlns,
...
encode_replace({replace, Xmlns, Id, By, Version,
		Conversation, Type, Replace_message, __Els},
	       __TopXMLNS) ->
...
decode_retract_user(__TopXMLNS, __Opts,
    ...
    {Type, Xmlns, Id, Version, Conversation, Symmetric,
     By} =
	decode_retract_user_attrs(__TopXMLNS, _attrs, undefined,
				  undefined, undefined, undefined, undefined,
				  undefined, undefined),
    {retract_user, Xmlns, Id, By, Symmetric, Version,
     Conversation, Type}.

decode_retract_user_attrs(__TopXMLNS,
			  [{<<"type">>, _val} | _attrs], _Type, Xmlns, Id,
			  Version, Conversation, Symmetric, By) ->
    decode_retract_user_attrs(__TopXMLNS, _attrs, _val,
			      Xmlns, Id, Version, Conversation, Symmetric, By);
decode_retract_user_attrs(__TopXMLNS,
			  [{<<"xmlns">>, _val} | _attrs], Type, _Xmlns, Id,
			  Version, Conversation, Symmetric, By) ->
    decode_retract_user_attrs(__TopXMLNS, _attrs, Type,
			      _val, Id, Version, Conversation, Symmetric, By);
decode_retract_user_attrs(__TopXMLNS,
			  [{<<"id">>, _val} | _attrs], Type, Xmlns, _Id,
			  Version, Conversation, Symmetric, By) ->
    decode_retract_user_attrs(__TopXMLNS, _attrs, Type,
			      Xmlns, _val, Version, Conversation, Symmetric,
			      By);
decode_retract_user_attrs(__TopXMLNS,
			  [{<<"version">>, _val} | _attrs], Type, Xmlns, Id,
			  _Version, Conversation, Symmetric, By) ->
    decode_retract_user_attrs(__TopXMLNS, _attrs, Type,
			      Xmlns, Id, _val, Conversation, Symmetric, By);
decode_retract_user_attrs(__TopXMLNS,
...
decode_retract_user_attrs(__TopXMLNS,
    ...
    decode_retract_user_attrs(__TopXMLNS, _attrs, Type,
			      Xmlns, Id, Version, Conversation, _val, By);
decode_retract_user_attrs(__TopXMLNS,
			  [{<<"by">>, _val} | _attrs], Type, Xmlns, Id, Version,
...
encode_retract_user({retract_user, Xmlns, Id, By,
...
encode_retract_all({retract_all, Xmlns, Symmetric,
		    Version, Conversation, Type},
		   __TopXMLNS) ->
    __NewTopXMLNS = xmpp_codec:choose_top_xmlns(Xmlns,
						[<<"https://xabber.com/protocol/rewrite">>,
...
decode_retract_message(__TopXMLNS, __Opts,
    ...
    {Type, Xmlns, Id, Version, Conversation, Symmetric,
     By} =
	decode_retract_message_attrs(__TopXMLNS, _attrs,
				     undefined, undefined, undefined, undefined,
				     undefined, undefined, undefined),
    {retract_message, Xmlns, Id, By, Symmetric, Version,
     Conversation, Type}.

decode_retract_message_attrs(__TopXMLNS,
			     [{<<"type">>, _val} | _attrs], _Type, Xmlns, Id,
			     Version, Conversation, Symmetric, By) ->
    decode_retract_message_attrs(__TopXMLNS, _attrs, _val,
				 Xmlns, Id, Version, Conversation, Symmetric,
				 By);
decode_retract_message_attrs(__TopXMLNS,
			     [{<<"xmlns">>, _val} | _attrs], Type, _Xmlns, Id,
			     Version, Conversation, Symmetric, By) ->
    decode_retract_message_attrs(__TopXMLNS, _attrs, Type,
...
encode_retract_message({retract_message, Xmlns, Id, By,
			Symmetric, Version, Conversation, Type},
		       __TopXMLNS) ->
    __NewTopXMLNS = xmpp_codec:choose_top_xmlns(Xmlns,
						[<<"https://xabber.com/protocol/rewrite">>,
