...
do_get_name({xabbertoken_revoke_all}) ->
    <<"revoke-all">>;
do_get_name({xabbertoken_xtoken,
             _,
             _,
             _,
             _,
...
records() ->
    [{xabbertoken_issue, 4},
     {xabbertoken_xtoken, 8},
     {xabbertoken_revoke, 1},
     {xabbertoken_feature, 0},
     {xabbertoken_revoke_all, 0},
     {xabbertoken_query, 1},
...
decode_xabbertoken_query_items_els(__TopXMLNS, __Opts,
    ...
    case xmpp_codec:get_attr(<<"xmlns">>,
        ...
        of
        <<"https://xabber.com/protocol/auth-tokens">> ->
            decode_xabbertoken_query_items_els(__TopXMLNS,
                                               __Opts,
                                               _els,
                                               [decode_xabbertoken_xtoken(<<"https://xabber.com/protocol/auth-tokens">>,
                                                                          __Opts,
...
decode_xabbertoken_query_els(__TopXMLNS, __Opts,
    ...
    case xmpp_codec:get_attr(<<"xmlns">>,
        ...
        of
        <<"https://xabber.com/protocol/auth-tokens">> ->
            decode_xabbertoken_query_els(__TopXMLNS,
                                         __Opts,
                                         _els,
                                         {value,
                                          decode_xabbertoken_xtoken(<<"https://xabber.com/protocol/auth-tokens">>,
...
decode_xabbertoken_ip(__TopXMLNS, __Opts,
    ...
    Cdata = decode_xabbertoken_ip_els(__TopXMLNS,
                                      __Opts,
                                      _els,
                                      <<>>),
    Cdata.
...
decode_xabbertoken_ip_els(__TopXMLNS, __Opts,
    ...
    decode_xabbertoken_ip_els(__TopXMLNS,
                              __Opts,
                              _els,
...
decode_xabbertoken_last_auth_els(__TopXMLNS, __Opts,
                                 [{xmlcdata, _data} | _els], Cdata) ->
    decode_xabbertoken_last_auth_els(__TopXMLNS,
                                     __Opts,
                                     _els,
                                     <<Cdata/binary, _data/binary>>);
decode_xabbertoken_last_auth_els(__TopXMLNS, __Opts,
...
decode_xabbertoken_expire_els(__TopXMLNS, __Opts,
                              [{xmlcdata, _data} | _els], Cdata) ->
    decode_xabbertoken_expire_els(__TopXMLNS,
                                  __Opts,
                                  _els,
                                  <<Cdata/binary, _data/binary>>);
decode_xabbertoken_expire_els(__TopXMLNS, __Opts,
...
decode_xabbertoken_description_els(__TopXMLNS, __Opts,
                                   [{xmlcdata, _data} | _els], Cdata) ->
    decode_xabbertoken_description_els(__TopXMLNS,
                                       __Opts,
                                       _els,
                                       <<Cdata/binary, _data/binary>>);
decode_xabbertoken_description_els(__TopXMLNS, __Opts,
...
decode_xabbertoken_device_els(__TopXMLNS, __Opts,
                              [{xmlcdata, _data} | _els], Cdata) ->
    decode_xabbertoken_device_els(__TopXMLNS,
                                  __Opts,
                                  _els,
                                  <<Cdata/binary, _data/binary>>);
decode_xabbertoken_device_els(__TopXMLNS, __Opts,
...
decode_xabbertoken_client_els(__TopXMLNS, __Opts,
                              [{xmlcdata, _data} | _els], Cdata) ->
    decode_xabbertoken_client_els(__TopXMLNS,
                                  __Opts,
                                  _els,
                                  <<Cdata/binary, _data/binary>>);
decode_xabbertoken_client_els(__TopXMLNS, __Opts,
...
decode_xabbertoken(__TopXMLNS, __Opts,
    ...
    Cdata = decode_xabbertoken_els(__TopXMLNS,
                                   __Opts,
                                   _els,
                                   <<>>),
    Cdata.
...
decode_xabbertoken_els(__TopXMLNS, __Opts,
                       [{xmlcdata, _data} | _els], Cdata) ->
    decode_xabbertoken_els(__TopXMLNS,
                           __Opts,
                           _els,
                           <<Cdata/binary, _data/binary>>);
...
decode_xabbertoken_revoke_els(__TopXMLNS, __Opts,
    ...
    case xmpp_codec:get_attr(<<"xmlns">>,
        ...
        of
        <<"https://xabber.com/protocol/auth-tokens">> ->
            decode_xabbertoken_revoke_els(__TopXMLNS,
                                          __Opts,
                                          _els,
                                          [decode_xabbertoken_xtoken(<<"https://xabber.com/protocol/auth-tokens">>,
                                                                     __Opts,
...
'encode_xabbertoken_revoke_$xtokens'([Xtokens | _els],
                                     __TopXMLNS, _acc) ->
    'encode_xabbertoken_revoke_$xtokens'(_els,
                                         __TopXMLNS,
                                         [encode_xabbertoken_xtoken(Xtokens,
                                                                    __TopXMLNS)
                                          | _acc]).
...
decode_xabbertoken_xtoken(__TopXMLNS, __Opts,
    ...
    {Ip,
     ...
     Description,
     Token} =
        decode_xabbertoken_xtoken_els(__TopXMLNS,
                                      __Opts,
                                      _els,
                                      undefined,
                                      undefined,
...
encode_xabbertoken_xtoken({xabbertoken_xtoken,
                           Token,
                           Uid,
                           Expire,
                           Client,
...
decode_xabbertoken_issue(__TopXMLNS, __Opts,
    ...
    {Client, Expire, Device, Description} =
        decode_xabbertoken_issue_els(__TopXMLNS,
                                     __Opts,
                                     _els,
                                     undefined,
                                     undefined,
...
encode_xabbertoken_issue({xabbertoken_issue,
                          Client,
                          Device,
                          Description,
                          Expire},
