...
decode_jingle_accept(__TopXMLNS, __Opts,
    ...
    Id = decode_jingle_accept_attrs(__TopXMLNS,
                                    _attrs,
                                    undefined),
    {jingle_accept, Id}.
...
decode_jingle_reject(__TopXMLNS, __Opts,
    ...
    __Els = decode_jingle_reject_els(__TopXMLNS,
                                     __Opts,
                                     _els,
                                     []),
    Id = decode_jingle_reject_attrs(__TopXMLNS,
                                    _attrs,
                                    undefined),
...
decode_jingle_reject_els(__TopXMLNS, __Opts,
    ...
    case proplists:get_bool(ignore_els, __Opts) of
        true ->
            decode_jingle_reject_els(__TopXMLNS,
                                     __Opts,
                                     _els,
                                     [_el | __Els]);
        false ->
...
decode_jingle_propose(__TopXMLNS, __Opts,
    ...
    __Els = decode_jingle_propose_els(__TopXMLNS,
                                      __Opts,
                                      _els,
                                      []),
    Id = decode_jingle_propose_attrs(__TopXMLNS,
                                     _attrs,
                                     undefined),
...
decode_jingle_propose_els(__TopXMLNS, __Opts,
    ...
    case proplists:get_bool(ignore_els, __Opts) of
        true ->
            decode_jingle_propose_els(__TopXMLNS,
                                      __Opts,
                                      _els,
                                      [_el | __Els]);
        false ->
