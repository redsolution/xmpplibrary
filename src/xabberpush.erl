...
records() ->
    [{xabber_push_enable, 4}, {xabber_push_disable, 2},
     {xabber_push_notification, 2},
     {xabber_push_security, 2}, {xabber_encryption_key, 1},
     {push_call, 0}, {encrypted, 2}].
...
encode_push_security({xabber_push_security, Cipher,
		      Encryption_key},
		     __TopXMLNS) ->
    __NewTopXMLNS =
	xmpp_codec:choose_top_xmlns(<<"https://xabber.com/protocol/push">>,
...
decode_xabber_push_disable(__TopXMLNS, __Opts,
    ...
    {Jid, Node} =
	decode_xabber_push_disable_attrs(__TopXMLNS, _attrs,
					 undefined, undefined),
...
encode_xabber_push_disable({xabber_push_disable, Jid,
			    Node},
			   __TopXMLNS) ->
    __NewTopXMLNS =
	xmpp_codec:choose_top_xmlns(<<"https://xabber.com/protocol/push">>,
...
decode_xabber_push_enable(__TopXMLNS, __Opts,
    ...
    {Xdata, Push_security} =
	decode_xabber_push_enable_els(__TopXMLNS, __Opts, _els,
				      undefined, undefined),
    {Jid, Node} =
	decode_xabber_push_enable_attrs(__TopXMLNS, _attrs,
					undefined, undefined),
...
decode_xabber_push_enable_attrs(__TopXMLNS,
				[{<<"node">>, _val} | _attrs], Jid, _Node) ->
    decode_xabber_push_enable_attrs(__TopXMLNS, _attrs, Jid,
				    _val);
decode_xabber_push_enable_attrs(__TopXMLNS,
				[_ | _attrs], Jid, Node) ->
    decode_xabber_push_enable_attrs(__TopXMLNS, _attrs, Jid,
...
encode_xabber_push_enable({xabber_push_enable, Jid,
			   Node, Xdata, Push_security},
			  __TopXMLNS) ->
    __NewTopXMLNS =
	xmpp_codec:choose_top_xmlns(<<"https://xabber.com/protocol/push">>,
				    [], __TopXMLNS),
