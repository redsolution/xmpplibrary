...
decode_perms_delete(__TopXMLNS, __Opts,
    ...
    __Els = decode_perms_delete_els(__TopXMLNS, __Opts,
				    _els, []),
    {perms_delete, __Els}.
...
decode_perms_delete_els(__TopXMLNS, __Opts,
    ...
    case proplists:get_bool(ignore_els, __Opts) of
      true ->
	  decode_perms_delete_els(__TopXMLNS, __Opts, _els,
				  [_el | __Els]);
      false ->
...
decode_perms_permissions_els(__TopXMLNS, __Opts,
	...
	of
      <<"https://xabber.com/protocol/permissions">> ->
	  decode_perms_permissions_els(__TopXMLNS, __Opts, _els,
				       [decode_perms_permission(<<"https://xabber.com/protocol/permissions">>,
								__Opts, _el)
					| Perms]);
      _ ->
...
'encode_perms_permissions_$perms'([Perms | _els],
				  __TopXMLNS, _acc) ->
    'encode_perms_permissions_$perms'(_els, __TopXMLNS,
...
encode_perms_permission({perms_permission, Name, Level,
			 Status, Seconds, Expires, Tag, Fixed, Display},
			__TopXMLNS) ->
    __NewTopXMLNS =
	xmpp_codec:choose_top_xmlns(<<"https://xabber.com/protocol/permissions">>,
				    [], __TopXMLNS),
