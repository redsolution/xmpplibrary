...
decode_vcard_PARENT_GROUP_els(__TopXMLNS, __Opts,
    ...
    decode_vcard_PARENT_GROUP_els(__TopXMLNS,
                                  __Opts,
                                  _els,
...
decode_vcard_STATUS(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_STATUS_els(__TopXMLNS,
                                    __Opts,
                                    _els,
                                    <<>>),
    Cdata.
...
decode_vcard_MEMBERSHIP(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_MEMBERSHIP_els(__TopXMLNS,
                                        __Opts,
                                        _els,
                                        <<>>),
    Cdata.
...
decode_vcard_MEMBERSHIP_els(__TopXMLNS, __Opts,
                            [{xmlcdata, _data} | _els], Cdata) ->
    decode_vcard_MEMBERSHIP_els(__TopXMLNS,
                                __Opts,
                                _els,
                                <<Cdata/binary, _data/binary>>);
decode_vcard_MEMBERSHIP_els(__TopXMLNS, __Opts,
...
decode_vcard_INDEX(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_INDEX_els(__TopXMLNS,
                                   __Opts,
                                   _els,
                                   <<>>),
    Cdata.
...
decode_vcard_INDEX_els(__TopXMLNS, __Opts,
                       [{xmlcdata, _data} | _els], Cdata) ->
    decode_vcard_INDEX_els(__TopXMLNS,
                           __Opts,
                           _els,
                           <<Cdata/binary, _data/binary>>);
...
decode_vcard_PRIVACY(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_PRIVACY_els(__TopXMLNS,
                                     __Opts,
                                     _els,
                                     <<>>),
    Cdata.
...
decode_vcard_PRIVACY_els(__TopXMLNS, __Opts,
                         [{xmlcdata, _data} | _els], Cdata) ->
    decode_vcard_PRIVACY_els(__TopXMLNS,
                             __Opts,
                             _els,
                             <<Cdata/binary, _data/binary>>);
...
decode_vcard_MEMBERS(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_MEMBERS_els(__TopXMLNS,
                                     __Opts,
                                     _els,
                                     <<>>),
    Cdata.
...
decode_vcard_MEMBERS_els(__TopXMLNS, __Opts,
                         [{xmlcdata, _data} | _els], Cdata) ->
    decode_vcard_MEMBERS_els(__TopXMLNS,
                             __Opts,
                             _els,
                             <<Cdata/binary, _data/binary>>);
    ...
    case xmpp_codec:get_attr(<<"xmlns">>,
        ...
        <<"vcard-temp">> ->
            decode_vcard_temp_els(__TopXMLNS,
                                  ...
                                  Org,
                                  Index,
                                  decode_vcard_PRIVACY(<<"vcard-temp">>,
                                                       __Opts,
                                                       _el),
                                  Bday,
                                  Key,
    ...
    case xmpp_codec:get_attr(<<"xmlns">>,
        ...
        <<"vcard-temp">> ->
            decode_vcard_temp_els(__TopXMLNS,
                                  ...
                                  Mailer,
                                  Adr,
                                  decode_vcard_MEMBERS(<<"vcard-temp">>,
                                                       __Opts,
                                                       _el),
                                  Status,
                                  Class,
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, _name, _attrs, _} = _el | _els], Membership,
                      Mailer, Adr, Members, Status, Class, Categories, Desc,
                      Parent, Uid, Prodid, Jabberid, Sound, Note, Role, Title,
                      Nickname, Rev, Sort_string, Org, Index, Privacy, Bday,
                      Key, Tz, Url, Email, Tel, Label, Fn, Version, N, Photo,
