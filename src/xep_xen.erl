...
do_encode({xen_notification, _, _, _} = Notification,
          TopXMLNS) ->
...
do_get_name({xen_notification, _, _, _}) ->
    <<"notification">>;
...
decode_xen_prefs(__TopXMLNS, __Opts,
    ...
    Jids = decode_xen_prefs_els(__TopXMLNS,
                                __Opts,
                                _els,
                                []),
    Default = decode_xen_prefs_attrs(__TopXMLNS,
                                     _attrs,
                                     undefined),
...
decode_xen_prefs_els(__TopXMLNS, __Opts,
    ...
    case xmpp_codec:get_attr(<<"xmlns">>,
        ...
        of
        <<"urn:xabber:xen:0">> ->
            decode_xen_prefs_els(__TopXMLNS,
                                 __Opts,
                                 _els,
                                 [decode_xen_jid(<<"urn:xabber:xen:0">>,
                                                 __Opts,
                                                 _el)
                                  | Jids]);
        _ ->
...
decode_xen_notify(__TopXMLNS, __Opts,
    ...
    {Addresses, Fallback, Notification} =
        decode_xen_notify_els(__TopXMLNS,
                              __Opts,
                              _els,
                              error,
                              [],
...
'encode_xen_notify_$fallback'([Fallback | _els],
                              __TopXMLNS, _acc) ->
    'encode_xen_notify_$fallback'(_els,
                                  __TopXMLNS,
...
decode_xen_jid(__TopXMLNS, __Opts,
    ...
    Jid = decode_xen_jid_els(__TopXMLNS,
                             __Opts,
                             _els,
                             <<>>),
    Rule = decode_xen_jid_attrs(__TopXMLNS,
                                _attrs,
                                undefined),
    {xen_jid, Rule, Jid}.
...
decode_xen_notification(__TopXMLNS, __Opts,
    ...
    __Els = decode_xen_notification_els(__TopXMLNS,
                                        __Opts,
                                        _els,
                                        []),
    {Type, Category} =
...
decode_xen_notification_els(__TopXMLNS, __Opts,
    ...
    decode_xen_notification_els(__TopXMLNS,
                                __Opts,
                                _els,
                                [_el | __Els]);
decode_xen_notification_els(__TopXMLNS, __Opts,
...
encode_xen_notification({xen_notification,
                         Type,
                         Category,
                         __Els},
                        __TopXMLNS) ->
...
decode_xen_fallback(__TopXMLNS, __Opts,
    ...
    Data = decode_xen_fallback_els(__TopXMLNS,
                                   __Opts,
                                   _els,
                                   <<>>),
    Lang = decode_xen_fallback_attrs(__TopXMLNS,
                                     _attrs,
                                     undefined),
    {text, Lang, Data}.
...
decode_xen_fallback_els(__TopXMLNS, __Opts,
    ...
    decode_xen_fallback_els(__TopXMLNS,
                            __Opts,
                            _els,
