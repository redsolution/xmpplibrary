...
-xml(xabbertoken_issue,
     ...
     module = 'xabbertoken',
     result = {xabbertoken_issue, '$client', '$os', '$expire'},
                refs = [#ref{name = xabbertoken_client, min = 0, max = 1, label = '$client'},
                             #ref{name = xabbertoken_os, min = 0, max = 1, label = '$os'},
...
-xml(xabbergroupchat_members_item,
     #elem{name = <<"item">>,
     xmlns = <<"http://xabber.com/protocol/groupchat#members">>,
	   module = 'xabbergroupchat',
     result = {xabbergroupchat_members_item,
...
-xml(xabbergroupchat_item,
     ...
     xmlns = <<"http://xabber.com/protocol/groupchat">>,
	   module = 'xabbergroupchat',
     result = {xabbergroupchat_item, '$id', '$jid', '$role', '$invited', 
     '$permission', '$restriction'},
	   attrs = [#attr{name = <<"id">>},
              #attr{name = <<"jid">>},
              #attr{name = <<"role">>},
...
-xml(xabbergroupchat_query_members,
     ...
     xmlns = <<"http://xabber.com/protocol/groupchat#members">>,
	   module = 'xabbergroupchat',
     result = {xabbergroupchat_query_members, '$version', '$nickname','$badge'},
     attrs = [#attr{name = <<"version">>}],
     refs = [#ref{name = xabbergroupchat_nickname, min = 0, max = 1, label = '$nickname'},
             #ref{name = xabbergroupchat_badge, min = 0, max = 1, label = '$badge'}
             ]
              }).
...
-xml(xabbergroupchat_x,
     ...
     xmlns = <<"http://xabber.com/protocol/groupchat">>,
	   module = 'xabbergroupchat',
     result = {xabbergroupchat_x, '$create', '$update', '$left', '$join', '$kicked', '$name', '$description', '$model',
     ...
     refs = [#ref{name = xabbergroupchat_name, min = 0, max = 1, label = '$name'},
             ...
             #ref{name = xabbergroupchat_domains, min = 0, max = 1, label = '$domains'},
             #ref{name = xabbergroupchat_contacts, min = 0, max = 1, label = '$contacts'},
             #ref{name = xabbergroupchat_update, min = 0, max = 1, label = '$create'},
             #ref{name = xabbergroupchat_create, min = 0, max = 1, label = '$update'},
