...
-record(encrypted_message, {sub_els = [] :: [xmpp_element() | fxml:xmlel()]}).
-type encrypted_message() :: #encrypted_message{}.
...
-type xmpp_element() :: xabbergroupchat_revoke() |
                        privacy_item() |
                        unique_request() |
                        xabbergroup_block() |
                        stanza_error() |
